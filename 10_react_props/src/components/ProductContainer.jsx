...
export default function ProduckContainer({ products }) {
  return (
    <div>
      {/* 
            ?
            ...
            - 아래의 코드에서는 products라는 props가 전달되었다면 map 메서드를 사용해
              products 배열을 순회하며서 배열의 길이만큼 ProductItem을 브라우저에 렌더링하지만
              products 라는 props가 절달되지 않았다면 map 메서드 자체가 동작하지 않음
              -> 오류도 발생하지 않음
        */}
