...
// 현재 날짜
let now = new Date();
console.log(now); // Mon Mar 04 2024 11:48:59 GMT+0900 (한국 표준시)

// 1000ms = 1s(1초)
// 1000ms * 3600 === 1s * 60 * 60 = 1h(한시간)
// 1000ms * 3600 * 24 === 24h
// 1970년 1월 1일 기준으로 해당 ms만큼 지난 시간
let Jan_01_1970 = new Date(1000 * 3600 * 24);
...
console.log(now.getDate() + "일"); // 일
console.log(now.getHours() + "시"); // 시
console.log(now.getMinutes() + "분"); // 분
console.log(now.getSeconds() + "초"); // 초
console.log(now.getMilliseconds() + "초"); // 밀리초
console.log(now.getDay() + "요일"); // 요일 (0 ~ 6) 일요일: 0 -> 일 ~ 토
...
// 메서드
console.log(Math.min(10, 2, 6, -50)); // -50, 최소값: 인자로 전달받은 값 중 최소값
console.log(Math.max(10, 2, 6, -50)); // 10, 최소값: 인자로 전달받은 값 중 최대값
...
console.log(Math.ceil(3.4)); // 4, 소수를 올림하여 정수로 변환 (반올림 x)
