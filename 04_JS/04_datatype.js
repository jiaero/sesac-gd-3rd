...
let fruits = ["apple", "oranage", "banana", "grape"];
let fruits2 = new Array("apple", "oranage", "banana", "grape");
...
// 숫자 + 문자
console.log(b + a); // 23
console.log(b - a); // -1 -> 문자가 숫자로 변환되어 계산됨. + 빼고는 다 계산 됨.
