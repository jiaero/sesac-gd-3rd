...
export default function ModuleCss() {
  ...
  return (
    <>
      ...
      <div className={[style.first, style.second].join(' ')}>방법 2. join 메서드 사용 (배열을 하나의 문자열로 합쳐주는 메서드)</div>
      <div className={className(style.first, style.second)}>방법 3. classname 모듈 사용</div>
    </>
  );
}
